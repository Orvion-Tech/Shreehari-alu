  ...
  return (
    <footer className="bg-section text-body pt-16 pb-8 border-t border-border">
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-16 mb-16">
            ...
            <div className="flex space-x-3 pt-2">
              {[1, 2, 3, 4].map((i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-full bg-card flex items-center justify-center border border-border text-body hover:text-accent hover:border-accent transition-all duration-300 shadow-sm"
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx}>
                  <Link href={link.href} className="text-body hover:text-accent transition-colors text-xs font-semibold uppercase tracking-wider">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="pt-2">
                <Link href="/services" className="text-accent hover:text-primary transition-colors text-xs font-bold uppercase tracking-widest">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-5">
              <li className="flex items-start">
                ...
                <span className="text-body text-sm leading-relaxed">123 Industrial Area, Phase 1, City Name, State, India 123456</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 text-accent mr-3 flex-shrink-0" />
                <a href="tel:+919876543210" className="text-body hover:text-accent transition-colors text-sm font-semibold">+91 98765 43210</a>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 text-accent mr-3 flex-shrink-0" />
                <a href="mailto:info@shreeharialu.com" className="text-body hover:text-accent transition-colors text-sm font-semibold">info@shreeharialu.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Bottom Strip */}
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-body/70 uppercase tracking-widest font-semibold">
